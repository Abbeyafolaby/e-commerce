      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        <div onClick={() => removeFromCart(id)} className='text-xl cursor-pointer'>
          ...
          <div className='flex gap-x-2 h-[36px] text-sm'>
            ...
            <div className='flex-1 flex items-center justify-around'>$ {price * 200}</div>
            <div className='flex-1 flex justify-end items-center text-primary font-medium'>{`$ ${price * 200 * amount}`}</div>
          </div>
        </div>
      </div>
    </div>
